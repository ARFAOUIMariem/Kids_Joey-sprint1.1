...
import com.onegateafrica.payloads.request.LoginRequest;
import com.onegateafrica.payloads.request.SignupRequest;
import com.onegateafrica.payloads.response.JwtResponse;
import com.onegateafrica.payloads.response.MessageResponse;
import com.onegateafrica.repository.RoleRepository;
...
public class AuthentificationController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        User user = new User(signUpRequest.getUsername(),
                ...
                encoder.encode(signUpRequest.getPassword()),signUpRequest.getNom(),signUpRequest.getPrenom(),signUpRequest.getNumtel());
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    case "admin":
                        ...
                        break;
                    case "enseignant":
                        Role modRole = roleRepository.findByName(ERole.ROLE_ENSEIGNANT)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(modRole);
                    ...
                    default:
                        ResponseEntity.ok(new MessageResponse("default"));
                }
            });
        }
