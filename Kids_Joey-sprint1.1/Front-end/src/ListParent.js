    ...
    return (
       ...
       <NavScreenA></NavScreenA>
        ...
        <Button
          ...
          title="Add"
          onPress={() =>this.props.navigation.navigate('AddParent')}
        />
      </View>
            ...
            <View style={styles.box}>
              ...
              <View style={styles.boxContent}>
                ...
                <View style={styles.buttons}>
                  ...
                  <TouchableHighlight style={[styles.button, styles.message]} onPress={() =>this.props.navigation.navigate('CompteDetailParent')}>
