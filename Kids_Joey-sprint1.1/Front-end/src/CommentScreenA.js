    ...
    let newDate = new Date()
        ...
        return (
          ...
          <View style={styles.box}><Text style={styles.text}>{currentDay}</Text><Text style={styles.text}>{currentMonth}</Text></View>
            ...
            <View style={{marginLeft:5}}><Text style={{color:'grey'}}>Rihem allouchi:</Text>
                <Text>u need to add some activities</Text></View>
        <Formik
      ...
      Alert.alert('comment Added')
        ...
        <Card style={styles.card}>
          <View style={styles.box}><Text style={styles.text}>{currentDay}</Text><Text style={styles.text}>{currentMonth}</Text></View>
            ...
            <View style={{marginLeft:5}}><Text style={{color:'grey'}}>Haifa allagui:</Text>
                <Text>thank u for the effort </Text></View>
        <Formik
     onSubmit={values => console.log(values)}
   >
     {({ handleChange, handleBlur, handleSubmit, values }) => (
